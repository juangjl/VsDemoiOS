...
struct WidgetItemTemperatureView: View
{
  //--------------------------------------------------------------------------------------------------------//
  //
  // Variables
  ...
  // Type1Unit
  @State var strType1Unit             : String = "oC"
  ...
  func DataUpdate()
  {
    ...
    self.strValueNow = String(format: "%0.1f", healthInfo.fTempNow)
    if(healthInfo.fTempCount == 0)
    {
      self.strValueMin = "--"
      self.strValueAvg = "--"
      self.strValueMax = "--"
    ...
    self.strValueMin = String(format: "%0.1f", healthInfo.fTempMin)
    self.strValueAvg = String(format: "%0.1f", healthInfo.fTempAvg)
    self.strValueMax = String(format: "%0.1f", healthInfo.fTempMax)   
  }
  ...
  {    
    ...
    //----------------------------------------------------------------//    
    self.strLabelTemperature               = "Temperature"   

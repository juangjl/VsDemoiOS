//--------------------------------------------------------------------------------//
// @file  WidgetItemHeartRateView.swift
// @version $Revision$
...
struct WidgetItemHeartRateView: View
{
  //--------------------------------------------------------------------------------------------------------//
  //
  // Variables
  ...
  //----------------------------------------------------------------//
  @State var strLabelHeartRate                      : String = ""  
  ...
  // State id
  //----------------------------------------------------------------//  
  @State var  strNowTag : String = "HR_NOW"
  ...
  func DataUpdate()
  {
    let vsInfoNow    = self.vsSDK.vsInfoNow  
    self.strValueNow  = String(format: "%0.0f", vsInfoNow.Float64Get(self.strNowTag))
    if(self.vsSDK.healthInfo.fHRCount == 0)
    {
      return
    }
    self.strValueMin = String(format : "%0.0f", floor(self.vsSDK.healthInfo.fHRMin))
    self.strValueAvg = String(format : "%0.1f", self.vsSDK.healthInfo.fHRAvg)
    self.strValueMax = String(format : "%0.0f", floor(self.vsSDK.healthInfo.fHRMax))
  }
  ...
  {    
    ...
    //----------------------------------------------------------------//    
    self.strLabelHeartRate                 = "Heart rate"   

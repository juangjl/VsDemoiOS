//--------------------------------------------------------------------------------//
// @file  WidgetItemGSensorPowerView.swift
// @version $Revision$
...
struct WidgetItemGSensorPowerView: View
{
  //--------------------------------------------------------------------------------------------------------//
  //
  // Variables
  ...
  // Title
  @State var strTitle           : String = "GSensor Power"
  ...
  {    
    ...
    self.strValueNow  = String(format: "%0.0f", healthInfo.fGSenGNow)
    if(healthInfo.fGSenGCount == 0)
    {
      self.strValueMin = "--"
      self.strValueAvg = "--"
      self.strValueMax = "--"
    ...
    self.strValueMin = String(format: "%0.0f", healthInfo.fGSenGMin)
    self.strValueAvg = String(format: "%0.0f", healthInfo.fGSenGAvg)
    self.strValueMax = String(format: "%0.0f", healthInfo.fGSenGMax)
  }
  ...
  {    
    ...
    //----------------------------------------------------------------//    
    self.strLabelGSensorPower              = "Activity Power"
      ...
      ZStack
      {
        VStack(alignment: .leading, spacing: 0)
        {
          ...
          HStack(alignment: .top, spacing: 10)
          {
            ...
            // title
            Text(self.strLabelGSensorPower)

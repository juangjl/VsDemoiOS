//--------------------------------------------------------------------------------//
// @file  ConfigItemVersionView.swift
// @version $Revision$
...
struct ConfigItemVersionView : View
{
  ...
  // Title
  //--------------------------------------------------------------------------------------------------------//
  @State var strTitle        : String   = "FW Version"
  @State var strDescription  : String   = "Device Firmware Version"
  ...
  // SREG_NAME
  //--------------------------------------------------------------------------------------------------------//
  @State var strSRegName  : String = SREG_MEAS_ZERO_BASE
  ...
  func onBtnOffClicked()
  {
    var  bRet  : Bool = FALSE
    
    self.strWriteValue = "OFF"
  ...
  func UIUpdate()
  {
    ...
    //----------------------------------------------------------------//
    self.strTitle         = "Firmware version"
    self.strDescription   = "Firmware version"
  }
  ...
  func OnTimer()
  {
    // time update
    iSec = iSec + 1
    self.strReadValue = String(format : "%d",self.vsSDK.iDeviceVersion)
  ...
  var body: some View
  {
    ...
    ZStack
    {
      ...
      .frame(width: self.fViewWidth, height: 150, alignment: .center)
